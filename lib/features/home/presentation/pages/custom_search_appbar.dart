...
class CustomSearchAppbar extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(backgroundColor: colors.buttonTapNotSelected,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
          bottom: Radius.circular(16.r), // You can adjust this value
        ),
      ),
      title: Text('search'.tr(),style: TextStyle(color: colors.textPrimary),),
          ...
          child: SearchAnchor(
            builder: (BuildContext context, SearchController controller) {
              return SearchBar(
                ...
                leading: Icon(Icons.search, color: colors.textBlue),
