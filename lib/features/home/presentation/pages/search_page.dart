          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'recent_search'.tr(),
                style:
                    AppTextStyles.s18w600.copyWith(color: colors.textGrey),
              ),
              SizedBox(
                height: 16,
              ),
              ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Row(
                      children: [
                        SvgPicture.asset(Assets.resourceImagesVectorsSearchAd,color: context.colors.textBlue,),
                        SizedBox(
                          width: 12,
                        ),
                        Text('last_search'.tr(), style: AppTextStyles.s14w400.copyWith(color: colors.textPrimary)),
                        Spacer(),
                        IconButton(
                            onPressed: () {
