...
class UserDataInfoModel {
  ...
  factory UserDataInfoModel.fromMap(Map<String, dynamic> map) {
    return UserDataInfoModel(
      ...
      studyYearId: map['study_year_id'] as int,
  ...
  factory UserDataInfoModel.fromJson(String source) => UserDataInfoModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
