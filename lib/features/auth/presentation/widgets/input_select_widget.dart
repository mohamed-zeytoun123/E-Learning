...
class InputSelectWidget extends StatefulWidget {
  ...
  final ValueChanged<String?>? onChanged; // <-- nullable to allow clearing
  final String? value; // القيمة الحالية من الخارج
...
class _InputSelectWidgetState extends State<InputSelectWidget> {
  ...
  @override
  void didUpdateWidget(covariant InputSelectWidget oldWidget) {
