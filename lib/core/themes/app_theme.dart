...
// import 'package:e_learning/core/theme/app_colors_extension.dart';
import 'package:e_learning/core/themes/app_colors_extension.dart';
import 'package:flutter/material.dart';
...
class AppTheme {
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      contentPadding: EdgeInsets.symmetric(vertical: 15, horizontal: 10),
      hintStyle: AppTextStyles.s14w400.copyWith(color: AppColors.lightGrey),
      errorStyle: AppTextStyles.s12w400.copyWith(color: Colors.red),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: AppColors.borderPrimaryDark),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: AppColors.borderPrimaryDark),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide:
            BorderSide(color: AppColors.backgroundDarkSecondary, width: 2),
      ),
      focusedErrorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: Colors.red, width: 2),
