...
class AppMessage {
  ...
  static void showFlushbar({
    ...
    iconColor ??= AppColors.titlePrimary;
    progressColor ??= AppColors.titlePrimary;
    ...
    _currentFlushbar = Flushbar(
      ...
      boxShadows: [
        BoxShadow(color: Colors.black38, blurRadius: 6.r, offset: Offset(0, 3)),
      ],
      icon: iconData != null
          ? Icon(iconData, size: sizeIcon.sp, color: iconColor)
          : null,
      title: title ?? '',
      ...
      progressIndicatorBackgroundColor: isShowProgress
  ...
  static void showSnackBar({
    ...
    backgroundColor ??= AppColors.messageError;
    messageColor ??= AppColors.titlePrimary;
